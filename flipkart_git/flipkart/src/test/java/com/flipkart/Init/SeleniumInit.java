...
import com.flipkart.page.indexpage.IndexPage;
	...
	public void setUp(Method method) throws IOException, InterruptedException {
		...
		if (targetBrowser == null || targetBrowser.contains("firefox")) {
			...
			System.setProperty("webdriver.chrome.driver",
					"V:\\testing\\chromedriver_win32\\chromedriver.exe");
			/*
			...
			System.setProperty("webdriver.ie.driver",
					"V:\\testing\\IEDriverServer_x64_2.41.0\\IEDriverServer.exe");

			/*
			 * System.setProperty("webdriver.ie.driver",
			 * "V:\\testing\\IEDriverServer_Win32_2.41.0\\IEDriverServer.exe");
			 */
